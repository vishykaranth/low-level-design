 ...
 * leetcode.string, whose length will not exceed 18. If there is a tie, return the smaller one as answer.
 *
 * <p>Solution O(N): General idea is to consider the first half of the leetcode.string and make a new leetcode.string
 * by reversing the first half of leetcode.string. Concatenate the first_half and the new_string and return
