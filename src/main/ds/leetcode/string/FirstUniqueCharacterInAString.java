...
/**
 * Created by gouthamvidyapradhan on 09/03/2017. Given a leetcode.string, find the first non-repeating
 ...
 *
 * <p>s = "loveleetcode", return 2. Note: You may assume the leetcode.string contain only lowercase letters.
 */
