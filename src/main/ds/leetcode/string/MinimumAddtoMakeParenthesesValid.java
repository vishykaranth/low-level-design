...
/**
 * Created by gouthamvidyapradhan on 20/08/2019 Given a leetcode.string S of '(' and ')' parentheses, we add
 * the minimum number of parentheses ( '(' or ')', and in any positions ) so that the resulting
 * parentheses leetcode.string is valid.
 *
 * <p>Formally, a parentheses leetcode.string is valid if and only if:
 *
 * <p>It is the empty leetcode.string, or It can be written as AB (A concatenated with B), where A and B are
 * valid strings, or It can be written as (A), where A is a valid leetcode.string. Given a parentheses
 * leetcode.string, return the minimum number of parentheses we must add to make the resulting leetcode.string valid.
 *
 * <p>Example 1:
 *
