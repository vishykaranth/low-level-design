 ...
 *
 * <p>Given a leetcode.string s, you are allowed to convert it to a palindrome by adding characters in front
 ...
 * append char at i to result leetcode.string else return leetcode.string (result + (0, i))
 */
