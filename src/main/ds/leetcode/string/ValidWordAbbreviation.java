...
/**
 * Created by gouthamvidyapradhan on 20/03/2019 Given a non-empty leetcode.string s and an abbreviation abbr,
 * return whether the leetcode.string matches with the given abbreviation.
 *
 * <p>A leetcode.string such as "word" contains only the following valid abbreviations:
 *
 ...
 * leetcode.string "word". Any other leetcode.string is not a valid abbreviation of "word".
 *
