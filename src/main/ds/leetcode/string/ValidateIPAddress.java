...
/**
 * Created by gouthamvidyapradhan on 01/08/2019 Write a function to check whether an input leetcode.string is
 ...
 *
 * <p>Note: You may assume there is no extra space or special characters in the input leetcode.string.
 *
 ...
 *
 * <p>Solution: O(N) split the leetcode.string by each '.' or ':' and then validate each parts.
 */
