...
/**
 * Created by gouthamvidyapradhan on 12/04/2018. Given a leetcode.string S, we can transform every letter
 * individually to be lowercase or uppercase to create another leetcode.string. Return a list of all possible
 ...
 *
 * <p>S will be a leetcode.string with length at most 12. S will consist only of letters or digits.
 *
