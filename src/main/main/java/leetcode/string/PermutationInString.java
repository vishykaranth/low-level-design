 ...
 * return true if s2 contains the permutation of s1. In other words, one of the first leetcode.string's
 * permutations is the substring of the second leetcode.string.
 *
