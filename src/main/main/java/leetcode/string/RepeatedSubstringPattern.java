...
/**
 * Created by gouthamvidyapradhan on 25/03/2017. Given a non-empty leetcode.string check if it can be
 * constructed by taking a substring of it and appending multiple copies of the substring together.
 * You may assume the given leetcode.string consists of lowercase English letters only and its length will
 * not exceed 10000.
 *
