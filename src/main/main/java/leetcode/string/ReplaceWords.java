 ...
 * length of the leetcode.string. Add all the words in the dictionary to a trie and evaluate each word in the
 * leetcode.string to check if it matches any path in the trie. Terminate the search as soon as a leaf node
