...
/**
 * Created by gouthamvidyapradhan on 04/07/2017. Given an input leetcode.string, reverse the leetcode.string word by
 * word.
 *
 ...
 * Could the input leetcode.string contain leading or trailing spaces? Yes. However, your reversed leetcode.string
 * should not contain leading or trailing spaces. How about multiple spaces between two words?
 * Reduce them to a single space in the reversed leetcode.string.
 */
