...
/**
 * Created by gouthamvidyapradhan on 12/10/2019 You want to form a target leetcode.string of lowercase
 * letters.
 *
 ...
 *
 * <p>If the sequence is possible to stamp, then return an leetcode.array of the index of the left-most
 ...
 * target leetcode.string is 'aaabb' and stamp is 'aabb' then first stamp would be at 0 resulting in aabb?
