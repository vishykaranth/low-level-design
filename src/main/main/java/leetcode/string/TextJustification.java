...
/**
 * Created by gouthamvidyapradhan on 09/03/2017. Given an leetcode.array of words and a length L, format the
 * text such that each line has exactly L characters and is fully (left and right) justified.
 *
 * <p>You should pack your words in a leetcode.greedy approach; that is, pack as many words as you can in
