...
/**
 * Created by gouthamvidyapradhan on 09/12/2017. Given a non-empty leetcode.string s, you may delete at most
 ...
 * could delete the character 'c'. Note: The leetcode.string will only contain lowercase characters a-z. The
 * maximum length of the leetcode.string is 50000.
 */
