...
/**
 * Created by gouthamvidyapradhan on 19/05/2017. The leetcode.string "PAYPALISHIRING" is written in a zigzag
 ...
 * will take a leetcode.string and make this conversion given a number of rows:
 *
 * <p>leetcode.string convert(leetcode.string text, int nRows); convert("PAYPALISHIRING", 3) should return
 * "PAHNAPLSIIGYIR".
 */
public class ZigZagConversion {
     ...
     *
     * @param s       input leetcode.string
     * @param numRows max rows
     * @return Result leetcode.string
     */
