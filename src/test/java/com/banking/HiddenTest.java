...
public class HiddenTest {
    ...
    public void invalidAccountNumberTest() {
        ...
        assertNotSame(bank.getBalance(john), bank.getBalance(julia));
        assertNotSame(bank.getBalance(john), bank.getBalance(daniel));
        assertNotSame(bank.getBalance(bob), bank.getBalance(smith));
    }
